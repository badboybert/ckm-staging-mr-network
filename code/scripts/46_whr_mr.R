...
# Reads <exp>.clumped.tsv + harmonised_whr/<exp>__<sub>.outcome.tsv. Run: Rscript 44_subtype_mr.R
...
write.csv(res, file.path(RES, "network_whradjbmi.csv"), row.names=FALSE)
cat("\nWrote results/network_whradjbmi.csv with", nrow(res), "subtype edges\n")
